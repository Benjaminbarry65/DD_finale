...
class BabyForm(forms.Form):
    ...
    def clean(self):
        ...
        if not name or not gender or not age or not location or not name_dropper or not time_arrival or not name_parents or not amount_paid or not period_stay or not baby_number:
